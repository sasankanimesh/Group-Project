...
const Settings = ({ navigation, route }) => {
  ...
  const handleLogout = () => {
    navigation.dispatch(StackActions.popToTop()); // Go to the top of the stack
    navigation.dispatch(StackActions.replace('Login')); // Replace the current screen with Login
  };
